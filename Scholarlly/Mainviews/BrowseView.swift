        ...
        VStack {
            ZStack{
                ForEach(bviewModel.programs, id: \.self){program in
                    CardView(programtitle: program.title, programdescription: program.description, programopp_type: program.opp_type, programinst: program.institution, programeligibility: program.eligibility, programmatch_score: program.match_score, programdeadline: program.deadline, programtags: program.tags)
                }
            }
        }
    }
